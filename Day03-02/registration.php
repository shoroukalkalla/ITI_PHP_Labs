...
<body>
    <div class="container">
        <form class="mt-4" method="POST" enctype="multipart/form-data" action="studentController.php">
            <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control <?= empty($ext) && $displayError ? 'border-danger' : '' ?>"
                    id="inputExt." placeholder=".." name="ext" value="<?= $ext ?>">
            </div>
            <div class="form-group">
            ...
            <button type="submit" class="btn btn-dark" name="registration">Add</button>
        </form>
    </div>
